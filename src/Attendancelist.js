...
const Attendancelist = () => {
    ...
    useEffect(async () => {
        try {
            let attendanceData = await fetch(`http://localhost:3000/attendance?studentId=${params.id}`)
    ...
    return (
        <>
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <Link to={`/add-attendance/${params.id}`} href="#" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i
